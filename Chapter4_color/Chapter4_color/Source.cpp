...
INT WINAPI WinMain(HINSTANCE hInstance, HINSTANCE, LPSTR, INT nCmdShow) {
	...
	vertices[4] = Vertex(-1.0f, -1.0f, 1.0f, D3DCOLOR_XRGB(255, 0, 255));
	vertices[5] = Vertex(-1.0f, 1.0f, 1.0f, D3DCOLOR_XRGB(0, 255, 255));
	vertices[6] = Vertex(1.0f, 1.0f, 1.0f, D3DCOLOR_XRGB(0, 255, 255));
	vertices[7] = Vertex(1.0f, -1.0f, 1.0f, D3DCOLOR_XRGB(255, 255, 255));
	vb->Unlock();
