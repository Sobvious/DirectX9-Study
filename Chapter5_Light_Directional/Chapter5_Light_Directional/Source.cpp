...
INT WINAPI WinMain(HINSTANCE hInstance, HINSTANCE, LPSTR, INT nCmdShow) {
	...
	// z+
	vertices[0] = Vertex(-1.0f, -1.0f, -1.0f, 0.0f, 0.0f, 1.0f, D3DCOLOR_XRGB(255, 255, 255));
	vertices[1] = Vertex(-1.0f, 1.0f, -1.0f, 0.0f, 0.0f, 1.0f, D3DCOLOR_XRGB(255, 255, 255));
	vertices[2] = Vertex(1.0f, 1.0f, -1.0f, 0.0f, 0.0f, 1.0f, D3DCOLOR_XRGB(255, 255, 255));
	vertices[3] = Vertex(1.0f, -1.0f, -1.0f, 0.0f, 0.0f, 1.0f, D3DCOLOR_XRGB(255, 255, 255));
	// z-
	vertices[4] = Vertex(-1.0f, -1.0f, 1.0f, 0.0f, 0.0f, -1.0f, D3DCOLOR_XRGB(255, 255, 255));
	vertices[5] = Vertex(-1.0f, 1.0f, 1.0f, 0.0f, 0.0f, -1.0f, D3DCOLOR_XRGB(255, 255, 255));
	vertices[6] = Vertex(1.0f, 1.0f, 1.0f, 0.0f, 0.0f, -1.0f, D3DCOLOR_XRGB(255, 255, 255));
	vertices[7] = Vertex(1.0f, -1.0f, 1.0f, 0.0f, 0.0f, -1.0f, D3DCOLOR_XRGB(255, 255, 255));
	// y-
	vertices[8] = Vertex(-1.0f, -1.0f, -1.0f, 0.0f, -1.0f, 0.0f, D3DCOLOR_XRGB(255, 255, 255));
	vertices[9] = Vertex(-1.0f, -1.0f, 1.0f, 0.0f, -1.0f, 0.0f, D3DCOLOR_XRGB(255, 255, 255));
	vertices[10] = Vertex(1.0f, -1.0f, 1.0f, 0.0f, -1.0f, 0.0f, D3DCOLOR_XRGB(255, 255, 255));
	vertices[11] = Vertex(1.0f, -1.0f, -1.0f, 0.0f, -1.0f, 0.0f, D3DCOLOR_XRGB(255, 255, 255));
	// y+
	vertices[12] = Vertex(-1.0f, 1.0f, -1.0f, 0.0f, 1.0f, 0.0f, D3DCOLOR_XRGB(255, 255, 255));
	vertices[13] = Vertex(-1.0f, 1.0f, 1.0f, 0.0f, 1.0f, 0.0f, D3DCOLOR_XRGB(255, 255, 255));
	vertices[14] = Vertex(1.0f, 1.0f, 1.0f, 0.0f, 1.0f, 0.0f, D3DCOLOR_XRGB(255, 255, 255));
	vertices[15] = Vertex(1.0f, 1.0f, -1.0f, 0.0f, 1.0f, 0.0f, D3DCOLOR_XRGB(255, 255, 255));
	// x-
	vertices[16] = Vertex(-1.0f, -1.0f, -1.0f, -1.0f, 0.0f, 0.0f, D3DCOLOR_XRGB(255, 255, 255));
	vertices[17] = Vertex(-1.0f, -1.0f, 1.0f, -1.0f, 0.0f, 0.0f, D3DCOLOR_XRGB(255, 255, 255));
	vertices[18] = Vertex(-1.0f, 1.0f, 1.0f, -1.0f, 0.0f, 0.0f, D3DCOLOR_XRGB(255, 255, 255));
	vertices[19] = Vertex(-1.0f, 1.0f, -1.0f, -1.0f, 0.0f, 0.0f, D3DCOLOR_XRGB(255, 255, 255));
	// x+
	vertices[20] = Vertex(1.0f, -1.0f, -1.0f, 1.0f, 0.0f, 0.0f, D3DCOLOR_XRGB(255, 255, 255));
	vertices[21] = Vertex(1.0f, -1.0f, 1.0f, 1.0f, 0.0f, 0.0f, D3DCOLOR_XRGB(255, 255, 255));
	vertices[22] = Vertex(1.0f, 1.0f, 1.0f, 1.0f, 0.0f, 0.0f, D3DCOLOR_XRGB(255, 255, 255));
	vertices[23] = Vertex(1.0f, 1.0f, -1.0f, 1.0f, 0.0f, 0.0f, D3DCOLOR_XRGB(255, 255, 255));
