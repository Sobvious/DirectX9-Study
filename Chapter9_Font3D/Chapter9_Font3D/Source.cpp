...
INT WINAPI WinMain(HINSTANCE hInstance, HINSTANCE, LPSTR, INT nCmdShow) {
	...
	D3DXVECTOR3 vecEye(4.0f, 2.0f, -4.0f);
	D3DXVECTOR3 vecLookAt(3.0f, 0.0f, 0.0f);
	...
	ID3DXMesh* text_mesh = 0;
	D3DXCreateText(device, hdc, "Hello, world!", 0.001f, 0.4, &text_mesh, 0, 0);
